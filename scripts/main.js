$(document).ready(function () {
    ...
    window.addEventListener('scroll', function() {
        ...
        var menuLinks = document.querySelectorAll('.menu_list-link');
        if(window.scrollY > 0) {
            header.style.backgroundColor = '#fff'; // Измените на желаемый цвет фона
            menuLinks.forEach(function(link) {
                link.style.color = '#000000'; // Измените на желаемый цвет ссылок
            });
        } else {
            header.style.backgroundColor = 'transparent'; // Вернуть к исходному цвету фона
            menuLinks.forEach(function(link) {
                link.style.color = '#000000'; // Вернуть к исходному цвету ссылок
            });
        }
    });
